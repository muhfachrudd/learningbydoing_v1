        ...
        setReviews([
          {
            ...
            rating: 5,
            comment:
              "Enak banget! Rasanya otentik dan porsinya pas. Pasti bakal pesan lagi!",
          ...
          },
          {
            ...
            rating: 4,
            comment:
              "Lumayan enak, tapi agak pedas untuk selera saya. Overall recommended!",
            created_at: new Date().toISOString(),
            user: {
              id: 2,
              name: "Siti Aminah",
          ...
          <Animated.View entering={FadeInUp.delay(100)} style={styles.titleRow}>
            <View style={{ flex: 1 }}>
              ...
              >
                ...
                />
                <Text
                  style={[styles.vendorBadgeText, { color: colors.primary }]}
                >
          ...
          >
            <View style={styles.sectionHeader}>
              ...
              <View style={styles.averageRating}>
                ...
                <Text
                  style={[styles.averageRatingText, { color: colors.text }]}
                >
                  {averageRating}
                </Text>
              </View>
